...
//
//     final mostPopularArticles = mostPopularArticlesFromJson(jsonString);

import 'dart:convert';

MostPopularArticles mostPopularArticlesFromJson(String str) =>
    MostPopularArticles.fromJson(json.decode(str));

String mostPopularArticlesToJson(MostPopularArticles data) =>
...
class MostPopularArticles {
  ...
  factory MostPopularArticles.fromJson(Map<String, dynamic> json) =>
      MostPopularArticles(
        status: json["status"],
...
enum Subsection { EMPTY, MUSIC, POLITICS, AUSTRALIA }
